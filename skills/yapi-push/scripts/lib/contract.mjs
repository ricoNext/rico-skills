export function createEndpoint({ controller, source, javaMethod, method, path, parameters = [], requestBody = null, responseType = 'void', title = '', inlineTypes = [] }) {
  return { controller, source, javaMethod, method, path, parameters, requestBody, responseType, title, inlineTypes };
}
